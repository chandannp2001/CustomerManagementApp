<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="com.sunbase.daoImpl.CustomerDAOImpl,com.sunbase.model.Customer, java.util.List"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="container">
		<a href="AddCustomer.jsp"><button class="addcustomer">
				<h2>Add Customer</h2>
			...
			<tbody>
				...
				<tr>
					...
					<td class="action-buttons"><a
						href="CustomerDetails?action=edit&cid=<%=c.getCustomerId()%>">
							<button class="edit">Edit</button> <br>
					</a> <a href="CustomerDetails?action=delete&cid=<%=c.getCustomerId()%>">
